...
#### Consuming Messages (Java Example)
...
// Parse EDR and extract Kafka consumer properties
String kafkaConsumerPropertiesString = edr.get("https://w3id.org/edc/v0.0.1/ns/kafkaConsumerProperties");
String topic = edr.get("https://w3id.org/edc/v0.0.1/ns/topic");

// Load properties
Properties props = new Properties();
props.load(new StringReader(kafkaConsumerPropertiesString));
...
#### Consuming Messages (Python Example)
...
# Parse EDR
topic = edr['https://w3id.org/edc/v0.0.1/ns/topic']
kafka_props_string = edr['https://w3id.org/edc/v0.0.1/ns/kafkaConsumerProperties']

# Parse properties (simplified - you'll need proper parsing)
bootstrap_servers = # extract from kafka_props_string
sasl_config = # extract from kafka_props_string
