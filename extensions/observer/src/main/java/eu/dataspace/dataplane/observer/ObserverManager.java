...
import eu.dataspace.dataplane.observer.subscriber.SendEventToObserver;
...
public class ObserverManager {
    ...
    public ObserverManager(Monitor monitor, ContractNegotiationService negotiationService,
