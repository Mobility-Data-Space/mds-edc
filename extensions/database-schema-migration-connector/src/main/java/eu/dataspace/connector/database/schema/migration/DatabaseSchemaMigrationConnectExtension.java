...
package eu.dataspace.connector.database.schema.migration;
...
public class DatabaseSchemaMigrationConnectExtension implements ServiceExtension {

    private static final String DEFAULT_SCHEMA = "public";

    private ConnectionFactoryDataSource dataSource;

    @Setting(key = "eu.dataspace.connector.postgresql.migration.schema", defaultValue = DEFAULT_SCHEMA, description = "Schema on which the migrations will be applied")
    private String schema;

    @Override
    public String name() {
        return "Connector Database Schema Migrations";
    }
