...
/**
 * This class is defined to patch the upstream PolicyMonitor that's buggy (see https://github.com/Mobility-Data-Space/mds-edc/issues/610)
 * The class can be deleted after we upgrade EDC to 1.0.0
 */
...
public class PolicyMonitor {
    ...
    public void monitor(PolicyMonitorEntry entry) {
        transactionContext.execute(() -> {
            ...
            entry.setModified(); // PATCHED CODE LINE
