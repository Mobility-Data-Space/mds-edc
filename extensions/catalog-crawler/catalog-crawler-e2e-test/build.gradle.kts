...
dependencies {
    ...
    compileOnly(project(":launchers:connectors:mds-dev"))
    ...
    testImplementation(libs.sovity.utilsJsonAndJsonLD)
    testImplementation(project(":extensions:catalog-crawler:catalog-crawler-db"))
    testImplementation(project(":extensions:sovity-wrapper:clients:java-client"))
