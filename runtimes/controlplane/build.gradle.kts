...
dependencies {
    ...
    runtimeOnly(libs.bundles.core.dataprotcol)
    runtimeOnly(libs.bundles.core.identity)
    // runtimeOnly(libs.bundles.core.secrets)
    runtimeOnly(libs.bundles.core.controlplane)
